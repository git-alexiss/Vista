...
<head>
  ...
  <style>
    ...
    .header { background: linear-gradient(135deg, #4D7298, #77A6B6); padding: 28px 32px; text-align: center; }
    ...
    .otp-box { background: #f0faf4; border: 2px dashed #77A6B6; border-radius: 12px;
    ...
    .otp-box .code  { font-size: 42px; font-weight: 800; letter-spacing: 12px;
                      color: #4D7298; display: block; margin: 8px 0 4px; }
    .otp-box .expiry { font-size: 12px; color: #e53e3e; font-weight: 600; }
    .warning { background: #fff8e7; border-left: 4px solid #D0EFB1; padding: 12px 16px;
               border-radius: 6px; font-size: 13px; color: #9fd865; margin-top: 16px; }
